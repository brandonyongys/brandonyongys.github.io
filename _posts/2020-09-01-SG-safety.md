...
# Major offences
SPF has also kindly shared the dataset indicating the number of cases for the following major offences, which are the sub categories of the main categories introduced previously:
...
It should be noted that the numbers in this dataset do not tally with the numbers in the previous sections as there would be offences in each main category that are considered as minor offences and are not included here. Also, the dataset spans from 2011 to 2018 and no available data for years prior to 2011 and 2019.
...
Earlier on, we saw that the crime rate per 100k population has been relatively stable and the annual cases since 2013 has been rising . But how many of the annual 
